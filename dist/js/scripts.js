 ...
 */
window.Drupal.behaviors.chem_h_subtheme = {
  // Attach Drupal Behavior.
  attach: function attach(context, settings) {
    // console.log("Attached.");
    (function ($) {
      var form = $('#block-chem-h-subtheme-search', context).detach();
      var menuSearchButton = $('<button>', {
      ...
      $('.su-multi-menu--dropdowns', context).append(menuSearchButton).closest('header').append(form); // add search key to search results page input

      var queryParam = new URLSearchParams(window.location.search);
      var searchResultsForm = $('#block-chem-h-subtheme-search-form .su-site-search__input');
...
/* harmony import */ var _chem_h_subtheme_behaviors_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chem_h_subtheme.behaviors.js */ "./src/js/chem_h_subtheme.behaviors.js");
/* harmony import */ var _chem_h_subtheme_behaviors_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_chem_h_subtheme_behaviors_js__WEBPACK_IMPORTED_MODULE_0__);
// Theme code.
